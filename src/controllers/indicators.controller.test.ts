...
describe('indicators controller', () => {
  ...
  describe('getByCountry', () => {
    it('responds 200 with indicator data', async () => {
      const mockData = [{ country: 'Mexico', category: 'GDP' }];
      vi.mocked(indicatorsService.getByCountry).mockResolvedValue(mockData as never);
  ...
  describe('getByCountryAndIndicator', () => {
    it('responds 200 with indicator data', async () => {
      const mockData = [{ country: 'Mexico', category: 'GDP' }];
      vi.mocked(indicatorsService.getByCountryAndIndicator).mockResolvedValue(
        mockData as never
      );
